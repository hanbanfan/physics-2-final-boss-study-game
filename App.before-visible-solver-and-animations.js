...
export default function App() {
  ...
  if (screen === "lesson") {
    ...
    return (
      <Screen calmMode={calmMode}>
        <Header title="Tiny Lesson Video" subtitle={`Chapter ${chapter.number}: ${chapter.title}`} />
        ...
        <Card>
          ...
          <View style={styles.lessonVideoFrame}>
            <Text style={styles.lessonVideoEmoji}>{lesson[0]}</Text>
            <Text style={styles.lessonVideoTitle}>Tiny Physics Clip</Text>
